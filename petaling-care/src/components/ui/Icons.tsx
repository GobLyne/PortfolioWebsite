    ...
    >
      ...
      <defs>
        <linearGradient id="logoGradient" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#00af9b" />
          <stop offset="50%" stopColor="#4caf50" />
          <stop offset="100%" stopColor="#fab400" />
        </linearGradient>
      </defs>
      {/* Leaves forming a heart/care symbol */}
      <g transform="translate(50, 50)">
        {/* Left leaf */}
        <path
          d="M-5,-30 Q-30,-25 -35,5 Q-30,25 0,40 Q-15,10 -5,-30"
          fill="#4caf50"
        />
        {/* Right leaf */}
        <path
          d="M5,-30 Q30,-25 35,5 Q30,25 0,40 Q15,10 5,-30"
          fill="#00af9b"
        />
        {/* Center accent */}
        <ellipse cx="0" cy="5" rx="8" ry="12" fill="#fab400" />
        {/* Small heart */}
        <path
          d="M0,-5 Q-8,-15 -15,-5 Q-15,5 0,15 Q15,5 15,-5 Q8,-15 0,-5"
          fill="#f0694b"
...
export function SportsIcon({ className = "", size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function WelfareIcon({ className = "", size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function InclusivityIcon({ className = "", size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function VolunteerIcon({ className = "", size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IntegrityIcon({ className = "", size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function DonateIcon({ className = "", size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
