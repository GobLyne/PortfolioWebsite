    ...
    <footer className="relative py-16 overflow-hidden">
      ...
      <Container className="relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-teal to-teal-light flex items-center justify-center">
                <span className="text-xl font-bold text-white">TC</span>
              </div>
              <div>
                <h3 className="font-bold text-white">Tahawwulat</h3>
                <p className="text-sm text-foreground-muted">Youth Camp</p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              {SOCIAL_LINKS.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-foreground-muted hover:text-gold hover:border-gold/30 transition-all duration-300"
                >
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-foreground-muted">
          <p>
            © {currentYear} {SITE_CONFIG.name}. Hak Cipta Terpelihara.
          </p>
      ...
      <motion.a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-green-500 flex items-center justify-center shadow-lg shadow-green-500/30 hover:shadow-green-500/50 transition-shadow"
